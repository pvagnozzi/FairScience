...
public class ProlificUsbSerialPortDriver : CommonUsbSerialPortDriver
{
    ...
    private int GetStatus()
    {
        ...
        switch (readBytesCount)
        {
            ...
            case STATUS_BUFFER_SIZE:
                ...
                break;
            default:
                throw new IOException($"Invalid CTS / DSR / CD / RI status buffer received, expected {STATUS_BUFFER_SIZE} bytes, but received {readBytesCount}");
        }
